...
import BlurBlackImg from '../public/blur-black.jpg'
...
const schema = yup
  .object({
    username: yup
      ...
      .max(20, 'Username should be lesser than 20 characters')
      .matches(/^[a-zA-Z\-]+$/, 'Username can only contain letters and dashes'),
...
export default function SignUp({ API_URL }) {
  ...
  const [sideImg, setSideImg] = useState(BlurBlackImg.src)
  useEffect(() => {
    axios
